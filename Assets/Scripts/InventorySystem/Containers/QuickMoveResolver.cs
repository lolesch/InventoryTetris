...
{
    /// <summary>
    /// The pure quick-move matrix (issue #30). Maps every (source container, menu context)
    ...
    /// containers in Store context return <see cref="QuickMoveIntentKind.None"/> until #33
    ...
    {
        public static QuickMoveIntent Resolve(MenuContextKind context, AbstractDimensionalContainer source,
            ...
            AbstractDimensionalContainer equipment, AbstractDimensionalContainer store)
        {
            ...
            if (context != MenuContextKind.Stash)
